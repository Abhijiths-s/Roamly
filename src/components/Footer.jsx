...
export default () => {
  ...
  return (
    <footer className="bg-black text-gray-200 font-roboto py-8 ">
      <ScrollReveal>
        <div className="max-w-screen-xl mx-auto px-6 sm:px-8 block">
          <div className="text-center mb-8">
            ...
            <p className="mt-4 text-sm md:text-base leading-relaxed">
              ...
              your next trip or reminiscing about your favorite journey, Roamly
              is here to inspire your wanderlust.
            </p>
          </div>
